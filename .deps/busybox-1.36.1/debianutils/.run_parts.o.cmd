cmd_debianutils/run_parts.o := gcc -Wp,-MD,debianutils/.run_parts.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DBB_VER='"1.36.1"' -O3 -fno-exceptions    -DKBUILD_BASENAME='"run_parts"'  -DKBUILD_MODNAME='"run_parts"' -c -o debianutils/run_parts.o debianutils/run_parts.c
