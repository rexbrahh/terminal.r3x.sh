cmd_console-tools/chvt.o := gcc -Wp,-MD,console-tools/.chvt.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DBB_VER='"1.36.1"' -O3 -fno-exceptions    -DKBUILD_BASENAME='"chvt"'  -DKBUILD_MODNAME='"chvt"' -c -o console-tools/chvt.o console-tools/chvt.c
