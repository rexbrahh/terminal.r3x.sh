cmd_console-tools/clear.o := gcc -Wp,-MD,console-tools/.clear.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DBB_VER='"1.36.1"' -O3 -fno-exceptions    -DKBUILD_BASENAME='"clear"'  -DKBUILD_MODNAME='"clear"' -c -o console-tools/clear.o console-tools/clear.c
