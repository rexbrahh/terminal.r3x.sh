cmd_klibc-utils/resume.o := gcc -Wp,-MD,klibc-utils/.resume.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DBB_VER='"1.36.1"' -O3 -fno-exceptions    -DKBUILD_BASENAME='"resume"'  -DKBUILD_MODNAME='"resume"' -c -o klibc-utils/resume.o klibc-utils/resume.c
