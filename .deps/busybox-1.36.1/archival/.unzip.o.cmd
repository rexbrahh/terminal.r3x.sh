cmd_archival/unzip.o := gcc -Wp,-MD,archival/.unzip.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DBB_VER='"1.36.1"' -O3 -fno-exceptions    -DKBUILD_BASENAME='"unzip"'  -DKBUILD_MODNAME='"unzip"' -c -o archival/unzip.o archival/unzip.c
