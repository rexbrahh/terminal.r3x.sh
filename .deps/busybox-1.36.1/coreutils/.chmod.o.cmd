cmd_coreutils/chmod.o := gcc -Wp,-MD,coreutils/.chmod.o.d   -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DBB_VER='"1.36.1"' -O3 -fno-exceptions    -DKBUILD_BASENAME='"chmod"'  -DKBUILD_MODNAME='"chmod"' -c -o coreutils/chmod.o coreutils/chmod.c
